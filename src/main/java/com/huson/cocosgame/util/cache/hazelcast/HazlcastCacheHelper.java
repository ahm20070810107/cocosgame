package com.huson.cocosgame.util.cache.hazelcast;

import com.huson.cocosgame.core.BMDataContext;
import com.huson.cocosgame.util.cache.CacheBean;
import com.huson.cocosgame.util.cache.CacheInstance;
import com.huson.cocosgame.util.cache.hazelcast.impl.ApiUserCache;
import com.huson.cocosgame.util.cache.hazelcast.impl.GameCache;
import com.huson.cocosgame.util.cache.hazelcast.impl.GameRoomCache;
import com.huson.cocosgame.util.cache.hazelcast.impl.MultiCache;
import com.huson.cocosgame.util.cache.hazelcast.impl.OnlineCache;
import com.huson.cocosgame.util.cache.hazelcast.impl.QueneCache;
import com.huson.cocosgame.util.cache.hazelcast.impl.SystemCache;
/**
 * Hazlcast缓存处理实例类
 * @author admin
 *
