package com.huson.cocosgame.web.handler.admin.system;
...
import com.huson.cocosgame.util.metadata.DatabaseMetaDataHandler;
import com.huson.cocosgame.util.metadata.UKColumnMetadata;
import com.huson.cocosgame.util.metadata.UKTableMetaData;
...
import com.huson.cocosgame.web.service.repository.jpa.MetadataRepository;
import com.huson.cocosgame.web.service.repository.jpa.SysDicRepository;
import com.huson.cocosgame.web.service.repository.jpa.TablePropertiesRepository;
...
public class MetadataController extends Handler{
    ...
    public ModelAndView update(ModelMap map , HttpServletRequest request , @Valid MetadataTable metadata) throws SQLException {
    	MetadataTable table = metadataRes.findById(metadata.getId()).get() ;
    ...
    public ModelAndView propertiesupdate(ModelMap map , HttpServletRequest request , @Valid TableProperties tp) throws SQLException {
    	TableProperties tableProperties = tablePropertiesRes.findById(tp.getId()).get() ;
    ...
    public ModelAndView delete(ModelMap map , HttpServletRequest request , @Valid String id) throws SQLException {
    	MetadataTable table = metadataRes.findById(id).get() ;
    ...
    public ModelAndView propertiesdelete(ModelMap map , HttpServletRequest request , @Valid String id , @Valid String tbid) throws SQLException {
    	TableProperties prop = tablePropertiesRes.findById(id).get() ;
    	tablePropertiesRes.delete(prop);
        return request(super.createRequestPageTempletResponse("redirect:/admin/metadata/table.html?id="+ (!Strings.isBlank(tbid) ? tbid : prop.getDbtableid())));
    }
